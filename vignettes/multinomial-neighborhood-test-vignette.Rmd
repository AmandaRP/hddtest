...
The above test likely produced a significant p-value meaning that we would reject the null. However, the difference isn't very interesting. Instead, we could have tested that the differences are within some neighborhood:
